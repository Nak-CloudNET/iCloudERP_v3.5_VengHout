...
--
-- Dumping data for table `erp_currencies`
INSERT INTO `erp_units` (`id`, `code`, `name`, `base_unit`, `operator`, `unit_value`, `operation_value`) VALUES ('1', 'C001', 'Unit', NULL, NULL, NULL, NULL);
INSERT INTO `erp_units` (`id`, `code`, `name`, `base_unit`, `operator`, `unit_value`, `operation_value`) VALUES ('2', 'C002', 'Pice', NULL, NULL, NULL, NULL);
INSERT INTO `erp_units` (`id`, `code`, `name`, `base_unit`, `operator`, `unit_value`, `operation_value`) VALUES ('3', 'C003', 'Pack', NULL, NULL, NULL, NULL);
...
INSERT INTO `erp_categories` (`id`, `brand_id`, `categories_note_id`, `code`, `name`, `image`, `jobs`, `auto_delivery`, `ac_sale`, `ac_cost`, `ac_stock`, `ac_stock_adj`, `ac_wip`, `ac_cost_variant`, `ac_purchase`, `prom_startdate`, `prom_enddate`, `prom_percentage`, `type`) VALUES ('1', NULL, '', 'RWM', 'Raw Material', 'no_image.png', '1', NULL, '410101', '500101', '100430', '500107', NULL, '500108', '100430', NULL, NULL, NULL, '');
INSERT INTO `erp_categories` (`id`, `brand_id`, `categories_note_id`, `code`, `name`, `image`, `jobs`, `auto_delivery`, `ac_sale`, `ac_cost`, `ac_stock`, `ac_stock_adj`, `ac_wip`, `ac_cost_variant`, `ac_purchase`, `prom_startdate`, `prom_enddate`, `prom_percentage`, `type`) VALUES ('2', NULL, '', 'FIP', 'Finish Products', 'no_image.png', '1', NULL, '410101', '500101', '100430', '500107', NULL, '500108', '100430', NULL, NULL, NULL, '');
INSERT INTO `erp_categories` (`id`, `brand_id`, `categories_note_id`, `code`, `name`, `image`, `jobs`, `auto_delivery`, `ac_sale`, `ac_cost`, `ac_stock`, `ac_stock_adj`, `ac_wip`, `ac_cost_variant`, `ac_purchase`, `prom_startdate`, `prom_enddate`, `prom_percentage`, `type`) VALUES ('3', NULL, '', 'DDDD01', 'Dries Food', 'no_image.png', '1', NULL, '410101', '500101', '100430', '500107', NULL, '500108', '100430', NULL, NULL, NULL, '');

--
-- Dumping data for table `erp_subcategories`
--

INSERT INTO `erp_subcategories` (`id`, `category_id`, `code`, `name`, `image`, `type`) VALUES ('1', '2', 'DKP', 'Drinks', 'no_image.png', '');
INSERT INTO `erp_subcategories` (`id`, `category_id`, `code`, `name`, `image`, `type`) VALUES ('2', '2', 'FDPs', 'Finish Products', 'no_image.png', '');
...
INSERT INTO `erp_variants` (`id`, `name`) VALUES ('1', 'Box');
INSERT INTO `erp_variants` (`id`, `name`) VALUES ('2', 'Case');
INSERT INTO `erp_variants` (`id`, `name`) VALUES ('3', 'Bottle');
INSERT INTO `erp_variants` (`id`, `name`) VALUES ('4', 'Pice');
INSERT INTO `erp_variants` (`id`, `name`) VALUES ('5', 'Pack');
