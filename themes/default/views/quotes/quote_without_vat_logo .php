...
<body>
	...
	<div class="container" style="width: 821px;margin: 0 auto;">
		<div class="col-xs-12" style="width: 794px;">
			...
			<div class="row">
				<div class="col-sm-8 col-xs-8" style="margin-bottom:10px;">
					<table style="font-size: 11px;">
						...
						<tr>
							<td style="width: 5%;font-weight:bold !important;font-size:13px !important">From</td>
							<td style="width: 2%;">:</td>
							<td style="width: 30%;font-weight:bold !important;font-size:14px !important;font-family:Time New Roman !important;"><?= $biller->name?$biller->name:$biller->name_kh; ?></td>
						</tr>
						<tr>
							<td style="width: 5%;font-weight:bold !important;font-size:13px !important">Address</td>
							<td style="width: 2%;">:</td>
							<td style="width: 30%;font-weight:bold !important;font-size:14px !important;font-family:Time New Roman !important;"><?= $biller->address?$biller->address:"unknown"; ?></td>
						</tr>
						<tr>
							<td style="width: 5%;font-weight:bold !important;font-size:13px !important">Tel</td>
							<td style="width: 2%;">:</td>
							<td style="width: 30%;font-weight:bold !important;font-size:14px !important;font-family:Time New Roman !important;"><?= $biller->phone?$biller->phone:"unknown"; ?></td>
						</tr>
						<?php } ?>
			...
			?>
			<div class="row" id="footer" style="margin-bottom:100px;margin-left:10px;">
