<?php
	//$this->erp->print_arrays($biller->address);
?>
                    ...
                    <tr style="border-left:none;border-right: none;border-top:none;">
                        <th colspan="9" style="border-left:none;border-right: none;border-top:none;border-bottom: 1px solid #000 !important;">
                            <div class="row" style="margin-top: 0px !important;">
								...
								<div  class="div_header col-md-5 col-sm-5 col-xs-5" style="font-size:10px !important; line-height: 20px !important;margin-left:-13px;margin-top:25px;">
									<div>
