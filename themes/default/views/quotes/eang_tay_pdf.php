    ...
    <div class="row">
        <div class="col-lg-7 col-lg-offset-2 col-xs-12" style="padding:0px;">
            <?php if (isset($biller->logo)) { ?>
			 ...
			 <?php } ?>
                <div class="col-xs-6 ">
                    <h2 style="font-family: Khmer M1;padding-left:70px;"><?= lang("Quotation"); ?></h2>
                </div>
		</div>
	</div>	
			<div class="row" >
				<div class="col-sm-12 col-xs-12 " >
						...
						<h3 style="font-size:14px !important;line-height:23px;text-align:center;margin-top:-10px;"><b>មានទទួលកិនភ្លីធំ ភ្លីក្បឿង <br> និងផ្តត់ផ្គង់សំភារៈសំណង់ ដែក <br> ស័ង្គសី អាលុយមីញ៉ូមគ្រប់ប្រភេទ</b></h3>
						<h4></h4>
