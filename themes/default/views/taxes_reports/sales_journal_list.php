...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('Sale Journal List'); ?> <?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="PrRData"
                        ...
                        <thead>
                        <tr>
                            <th style="width:3% !important;"><?= lang("Nº"); ?></th>
							<th style="width:25% !important;"><?= lang("enterprise"); ?></th>
                            <th style="width:7% !important;"><?= lang("Year"); ?></th>
                            <th style="width:7% !important;"><?= lang("Month"); ?></th>
                            <th style="width:10% !important;"><?= lang("Taxable Value"); ?></th>
                            <th style="width:10% !important;"><?= lang("VAT"); ?></th>
							<th style="width:13% !important;"><?= lang("Journal Date"); ?></th>
                            <th style="width:15% !important;"><?= lang("Journal Location"); ?></th>
                            <th style="width:10% !important;"><?= lang("action"); ?></th>
						...
						?>
							<tr>
								...
								<td><?=$confirm_tax_report->yearly;?><input type="hidden" class="year" value="<?=$confirm_tax_report->yearly;?>"></td>
								...
								<td><?="<div class='text-center'><a class=\"tip\" title='" . lang("view_report") . "'target='_blank' href='" . site_url('taxes_reports/sales_jounal_view_form/'.($confirm_tax_report->monthly).'/'.$confirm_tax_report->yearly.'/'.$confirm_tax_report->group_id) . "'><span class='label label-primary'>" . lang("view_report") . "</span></a></div>"?></td>
							</tr>
						<?php
							$i++;
						} 
		 ...
		 $('.jn_date').live('change ',function(){
				if(confirm("Are you sure you want to update this?")){
					...
					$.ajax({
                        ...
                        data: {journal_date:journal_date,month:month,year:year,'type':'SALE'},
						success:function(re){
			...
			$('.location').live('change ',function(){
				if(confirm("Are you sure you want to update this?")){
					...
					$.ajax({
                        ...
                        data: {location:location,month:month,year:year,'type':'SALE'},
						success:function(re){
