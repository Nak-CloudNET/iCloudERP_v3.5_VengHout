            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                        <?= lang("rate", "rate"); ?>
                        <?php 
							echo form_input('rate', '', 'class="form-control" id="rate" required="required" ');
						?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group person">
                        <?= lang("name", "name"); ?>
                        <?php 
							echo form_input('name', '', 'class="form-control" id="name" required="required"');
						?>
                    </div>
                    <div class="form-group">
                        <?= lang("reduct_tax", "reduct_tax"); ?>
                        <?php echo form_input('reduct_tax', '', 'class="form-control" id="reduct_tax" required="required"'); ?>
                    </div>
				</div>
				<div class="col-md-6">
                    <div class="form-group person">
                        ...
                        <?php 
							echo form_input('min_salary', '', 'class="form-control" id="min_salary" required="required"');
						?>
                    </div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
                        ...
                        <?php echo form_input('max_salary', '', 'class="form-control" id="max_salary" required="required"'); ?>
                    </div>
				</div>
			</div>
