<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('account/getConditionTax') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, {"mRender": currencyFormat}, null, null, null , {"bSortable": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('rate');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('min_salary');?>]", filter_type: "text", data: []},
			{column_number: 5, filter_default_label: "[<?=lang('max_salary');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('reduct_tax');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
<?php if ($Owner) {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('condition_tax'); ?></h2>
            ...
            <ul class="btn-tasks"> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('account/add_condition_tax'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_condition_tax"); ?></a></li>
						<?php if ($Owner || $Admin) { ?>
							<li>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="width:20%;"><?= lang("min_salary"); ?></th>
							<th style="width:20%;"><?= lang("max_salary"); ?></th>
							<th style="width:20%;"><?= lang("reduct_tax"); ?></th>
