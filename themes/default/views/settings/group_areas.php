...
<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getGroupArea') ?>',
            ...
            "aoColumns": [{"bVisible": false}, null, null, {"bSortable": false}]
        });
    });
</script>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_group_area') ?>" class="tip" href="<?php echo site_url('system_settings/add_group_area'); ?>" data-toggle="modal" data-target="#myModal">
