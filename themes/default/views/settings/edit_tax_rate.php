<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php echo form_open("system_settings/edit_tax_rate/" . $id); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_input('code', $tax_rate->code, 'class="form-control" id="code" required="required"'); ?> </div>
            </div>
            <div class="form-group">
                <label class="control-label" for="rate"><?php echo $this->lang->line("tax_rate"); ?></label>

                <div
                    class="controls"> <?php echo form_input('rate', $tax_rate->rate, 'class="form-control" id="rate" required="required"'); ?> </div>
            </div>
            <div class="form-group">
                <label for="type"><?php echo $this->lang->line("type"); ?></label>

                <div class="controls"> <?php $type = array('1' => lang('percentage'), '2' => lang('fixed'));
                    echo form_dropdown('type', $type, $tax_rate->type, 'class="form-control" id="type" required="required"'); ?> </div>
            </div>
        </div>
