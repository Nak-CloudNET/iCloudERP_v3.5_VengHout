            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('system_settings/add_brand'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_brand') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('system_settings/import_brands'); ?>" data-toggle="modal" data-target="#myModal">
