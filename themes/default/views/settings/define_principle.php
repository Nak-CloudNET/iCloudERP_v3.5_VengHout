...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('define_principle'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('system_settings/create_define_principle'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_principle') ?></a></li>
                        ...
                        foreach ($rows as $row) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <?php echo '<a target="_blank" class="tip" title="' . $this->lang->line("define_principle_rate") . '" href="' . site_url('system_settings/define_principle_rate/' . $row->id) . '"><i class="fa fa-tasks"></i></a> <a class="tip" title="' . $this->lang->line("edit_principle") . '" data-toggle="modal" data-target="#myModal" href="' . site_url('system_settings/edit_define_principle/' . $row->id) . '"><i class="fa fa-edit"></i></a> <a href="#" class="tip po" title="' . $this->lang->line("delete_principle") . '" data-content="<p>' . lang('r_u_sure') . '</p><a  class=\'btn btn-danger\'  href=\'' . site_url('system_settings/delete_define_principle/' . $row->id) . '\'>' . lang('i_m_sure') . '</a> <button class=\'btn po-close\'>' . lang('no') . '</button>"><i class="fa fa-trash-o"></i></a>'; ?>
                                </td>
                            </tr>
                        <?php
                        }
