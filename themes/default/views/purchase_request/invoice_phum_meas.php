...
<div class="container" style="width: 821px;margin: 0 auto;">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <?php if ($logo) { ?>
                ...
                <div class="col-xs-6 col-sm-6" id="shopinfo"style="text-align:center !important;">

                    <h3 style="font-family:Times New Roman !important;font-weight:bold !important;"><?= $billers->company;?></h3>

                    <p style="font-size: 15px; line-height: 20px;"><?= $billers->address ?></p>
                    <P>
                        <?php
                        if($billers->phone){
    ...
    <h3 style="font-family:Times New Roman !important;font-weight:bold !important; text-align:center"><?= lang("Purchase Request")?></h3>
    <br>
    <div class="col-lg-12">
    ...
    <div class="row" id="footer">
        <div class="col-lg-4 col-xs-4 col-sm-4 ">
            <p class="bold text-center"><?= lang("request_by"); ?></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
        ...
        <div class="col-lg-4 col-xs-4 col-sm-4 ">
            <p class="bold text-center"><?= lang("checked_by"); ?></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p style="border-bottom: 1px solid #666;">&nbsp;</p>
            <p><?= lang("name"); ?> :  ...................................</p>
        ...
        <div class="col-lg-4 col-xs-4 col-sm-4 ">
            <p class="bold text-center"><?= lang("approve_by"); ?></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p style="border-bottom: 1px solid #666;">&nbsp;</p>
            <p><?= lang("name"); ?> :  ...................................</p>
