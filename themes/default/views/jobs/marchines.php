<script>
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('jobs/getMarchine') ?>',
            ...
            {column_number: 1, filter_default_label: "[<?=lang('marchine_name');?>]", filter_type: "text", data: []},
...
<?php 
	if ($Owner) {
		echo form_open('jobs/marchine_actions', 'id="action-form"');
	} 
?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('list_marchines'); ?></h2>
            ...
            <ul class="btn-tasks"> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('jobs/add_marchine'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_marchine"); ?></a></li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li><a href="#" class="bpo" title="<?= $this->lang->line("delete_marchines") ?>"
                               data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_marchines') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="width:20%;"><?= lang("marchine_name"); ?></th>
                            <th style="width:20%;"><?= lang("branch_name"); ?></th>
