...
<script type="text/javascript">
    var product_tax = 0, invoice_tax = 0, total_discount = 0, product_discount = 0, order_discount = 0, total = 0, tax_rates = <?php echo json_encode($tax_rates); ?>;
    ...
    function loadItems() {
        ...
        if (__getItem('positems')) {
            ...
            $.each(positems, function () {
				...
				var imgs = $('<span></span>');
				var newImage = '<div class=""><img src="'+site.base_url+'assets/uploads/'+picture+'" alt="' +item_name+ '" style="width:70px; height:70px;" /></div>';
				imgs.html(newImage); 
				imgs.prependTo(".inner");
