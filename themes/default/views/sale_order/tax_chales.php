				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped print-table order-table">
						...
						<?php if ($inv->grand_total != $inv->total) { ?>
							<tr>
								<td colspan="8" style="text-align:right; padding-right:10px;"><?= lang("សរុប <br/> Sub Total"); ?>
									<?//= $tcol; ?>
						...
						?>
							<td colspan="8" style="text-align:right; font-weight:bold;"><?= lang("សរុបរួម <br/> Grand_Total"); ?>
							</td>
							<!-- <td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?//= $this->erp->formatMoney($inv->grand_total); ?></td> -->
							<td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?=$this->erp->formatMoney(($inv->total + $inv->product_tax) - $inv->order_discount + $inv->shipping);?></td>
						</tr>
						<tr>
							<td colspan="7" style="text-align:center; font-weight:bold;"><?= $this->erp->decode_html(strip_tags($invs->sale_note));?></td>
							<td></td>
							<td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?=$this->erp->formatMoney($invs->total_amount);?></td>
						</tr>
						<?php //if ($invs->order_tax != 0) {
							echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px; font-weight:bold;">' . lang("អាករលើតម្លៃបន្ថែម ".number_format($invs->tax)."% <br/>".$invs->name).'</td><td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;">' . $this->erp->formatMoney($invs->order_tax) . '</td></tr>';
						//}
						?>
						<tr>
							<td colspan="8" style="text-align:right; font-weight:bold;"><?= lang("សរុបរួម <br/> Grand_Total"); ?>
							...
							<!-- <td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?//= $this->erp->formatMoney($inv->grand_total); ?></td> -->
							<td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;"><?=$this->erp->formatMoney($invs->total_amount + $invs->order_tax);?></td>
						</tr>
						<?php if($inv->paid != 0){?>
						<!-- <tr>
							<td colspan="3"
