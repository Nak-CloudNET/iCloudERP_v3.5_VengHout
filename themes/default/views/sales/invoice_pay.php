			...
			<tr style="display:none;">
				...
				?>
					<tr>
                        ...
                        <th style="border-right:2px solid #000;border-top:2px solid #000;border-left:none;" class="text-right"><?= $this->erp->formatMoney($pos_paid-$khr_paid); ?></th>
                    </tr>
                    <tr>
                        ...
                        <th style="border-bottom:2px solid #000;border-right:2px solid #000;border-left:none;" class="text-right"><?= $this->erp->formatMoney($inv->other_cur_paid) ; ?></th>
                    </tr>
				...
				<?php
                    ...
                    <tr>
						...
						<th style="border-top:2px dotted #000" class="text-right">
							...
							<?php// number_format(round((($pos_paid+$amount_kh_to_us) - $grand_totals)*(($pos_settings->in_out_rate) ? $outexchange_rate->rate:$exchange_rate->rate)), -3) ; ?>
						</th>
                    </tr>
...
<?php } ?>
	<span class="pull-right col-xs-12">
        <a href="<?=base_url()?>pos/view_cabon_bk/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("jones_the_grocer"); ?></a>
    </span>
    <span class="pull-right col-xs-12">
