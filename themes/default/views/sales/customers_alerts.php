...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('sales/getCustomersAlerts' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, null,null, {"bVisible": false},{"bVisible": false}],
			...
			{column_number: 7, filter_default_label: "[yyyy-mm-dd]", filter_type: "text", data: []},
        ], "footer");
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("sales/customers_alerts"); ?>
                    <div class="row">
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
							...
							<th class="col-md-1"><?php echo $this->lang->line("gender"); ?></th>
