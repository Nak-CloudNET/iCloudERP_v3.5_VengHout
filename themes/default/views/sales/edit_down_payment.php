										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select name="depreciation_type" id="depreciation_type_1"
													...
													<option   <?=($order_down->depreciation_type == '2'?"selected":"selected"); ?> value="2"><?= lang("custom"); ?></option>
			...
			if(rate == '' || rate < 0) {
				...
				if(term == '' || term <= 0) {
					...
					if(p_type == 1){
						...
						var rate_amount = ((rate/100));
						var payment = Math.round((total_loan * rate_amount)*((Math.pow((1+rate_amount),term))/(Math.pow((1+rate_amount),term)-1)),2);
