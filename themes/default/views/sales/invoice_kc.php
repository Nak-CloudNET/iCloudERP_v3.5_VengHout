	...
	<div class="container" style="width: 821px;margin: 0 auto;">
		<div class="col-sm-12 col-xs-12" style="width: 794px;">
					...
					<table style="width: 100%" cellspacing="10">
						<tbody style="border:1px solid #000; border-radius: 5px; padding: 5px;">
							<tr>
								...
								<td>Tel</td>
                                <td>: 077 37 38 39 (​ផ្នែកជំនួយការ)</td>
							</tr>
							<tr>
								<td></td>
		 ...
		 <div id="footer" class="row">
             <div class="col-sm-4 col-xs-4" style="margin-top: 50px !important;">
				<hr style="margin-bottom: 3px; border:1px solid #000; width: 80%">
				<center>
                    <p style="font-size: 14px;">ហត្ថលេខា និងឈ្មោះអ្នករៀបចំ</p>
             ...
             <div class="col-sm-4 col-xs-4" style="margin-top: 50px !important;">
				<hr style="margin-bottom: 3px; border:1px solid #000; width: 80%">
				<center>
                    <p style="font-size: 14px;">ហត្ថលេខា និងឈ្មោះអ្នកលក់</p>
             ...
             <div class="col-sm-4 col-xs-4" style="margin-top: 50px !important;">
				<hr style="margin-bottom: 3px; border:1px solid #000; width: 80%">
				<center>
                    <p style="font-size: 14px;">ហត្ថលេខា និងឈ្មោះអ្នកទិញ</p>
