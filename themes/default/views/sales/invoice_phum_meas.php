				...
				<div class="col-sm-12 col-xs-12" >
					<table class="table table-bordered" style="margin-top: 10px;">
						<thead style="font-size: 11px;">
                            <tr>
                                <th colspan="9" style="font-weight: normal; border-top: #FFFFFF 1px solid !important;border-left: #FFFFFF 1px solid !important;border-right: #FFFFFF 1px solid !important;">
                                    <div class="row" >
                                        <div class="col-sm-7 col-xs-7 " style="margin-left: -10px;">
                                            <table style="font-size:12px;">
                                                    <tr>
                                                        <td style="width: 5%;border: #FFFFFF 1px solid !important;"">ឈ្មោះក្រុមហ៊ុន </br> Company Name</td>
                                                        <td style="width: 5%;border: #FFFFFF 1px solid !important;"">:</td>
                                                        <td style="width: 30%;border: #FFFFFF 1px solid !important;""><?= $customer->company ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="border: #FFFFFF 1px solid !important;">អតិថិជន </br> Customer Name</td>
                                                        <td style="border: #FFFFFF 1px solid !important;">:</td>
                                                        <?php if(!empty($customer->name_kh)) { ?>
                                                            <td style="border: #FFFFFF 1px solid !important;"><?= $customer->name_kh ?></td>
                                                        <?php }else { ?>
                                                            <td style="border: #FFFFFF 1px solid !important;"><?= $customer->names ?></td>
                                                        <?php } ?>
                                                    </tr>

                                                    <tr>
                                                        <td style="border: #FFFFFF 1px solid !important;">អាសយដ្ឋាន </br> Address</td>
                                                        <td style="border: #FFFFFF 1px solid !important;">:</td>
                                                        <?php if(!empty($customer->address_kh)) { ?>
                                                            <td style="border: #FFFFFF 1px solid !important;"><?= $customer->address_kh?></td>
                                                        <?php }else { ?>
                                                            <td style="border: #FFFFFF 1px solid !important;"><?= $customer->address ?></td>
                                                        <?php } ?>
                                                    </tr>

                                                    <tr>
                                                        <td style="border: #FFFFFF 1px solid !important;">ទូរស័ព្ទលេខ (Tel)</td>
                                                        <td style="border: #FFFFFF 1px solid !important;">:</td>
                                                        <td style="border: #FFFFFF 1px solid !important;"><?= $customer->phone ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="border: #FFFFFF 1px solid !important;">លេខអត្តសញ្ញាណកម្ម អតប </br> VAT No.</td>
                                                        <td style="border: #FFFFFF 1px solid !important;">:</td>
                                                        <td style="border: #FFFFFF 1px solid !important;"><?= $customer->vat_no ?></td>
                                                    </tr>

                                            </table>
                                        </div>
                                        <div class="col-sm-5 col-xs-5" style="margin-right: -10px;">
                                            <table style="font-size: 12px;">
                                                <tr>
                                                    <td style="width: 20%;border: #FFFFFF 1px solid !important;">លេខរៀងវិក្កយបត្រ </br> Invoice No.</td>
                                                    <td style="width: 5%;border: #FFFFFF 1px solid !important;">:</td>
                                                    <td style="width: 30%;border: #FFFFFF 1px solid !important;"><?= $invs->reference_no ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="border: #FFFFFF 1px solid !important;">កាលបរិច្ឆេទ </br> Date</td>
                                                    <td style="border: #FFFFFF 1px solid !important;">:</td>
                                                    <td style="border: #FFFFFF 1px solid !important;"><?= $invs->date; ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
							...
							<tr class="thead" style="background-color: #444 !important; color: #FFF !important;">
								...
								<th style="width: 150px;">តម្លៃ<br /><?= strtoupper(lang('unit_price')) ?></th>
