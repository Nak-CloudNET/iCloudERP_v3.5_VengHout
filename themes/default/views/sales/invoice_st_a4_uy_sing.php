				...
				<div class="col-sm-12 col-xs-12">
					<table class="table table-bordered" style="margin-top: 10px;">
						<tbody style="font-size: 11px;">
							...
							<tr>
								<?php if ($invs->grand_total == $invs->total) { ?>
								<td rowspan="<?= $row; ?>"  style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">
									<?php if (!empty($invs->invoice_footer)) { ?>
								...
								<?php } ?>
								<td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;padding: 0px">
									<div style="height: 35px; border-bottom: 1px solid; line-height: 34px">
									បន្ថែម / <?= strtoupper(lang('shipping_fee')) ?>
									(<?= $default_currency->code; ?>)
									</div>
									<div style="line-height: 28px">
									សរុបរួម / <?= strtoupper(lang('total_amount')) ?>
									(<?= $default_currency->code; ?>)
									</div>
								</td>
								<td align="right" style="padding:0px">
									<div style="height: 35px;border-bottom: 1px solid black;line-height: 35px;padding-right:7px;">$<?= $invs->shipping; ?></div>
									<div style="line-height: 27px;padding-right:7px;">$<?= $this->erp->formatMoney($invs->grand_total); ?></div>
								</td>
							</tr>
