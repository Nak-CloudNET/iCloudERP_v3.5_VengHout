...
<br>
					...
					<div class="col-sm-6 col-xs-6">
						<div class="row">
							...
							<div class="col-sm-5 col-xs-5 text-left">
								<?= $customer->names ? $customer->names : $customer->company; ?>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-5 col-xs-5 text-left" style="height: 41px; padding-top: 12px">
								<?= $customer->company ? $customer->company : $customer->names; ?>
							</div>
						</div>
						<div class="row">
			...
			<td colspan="5"> 
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped print-table order-table" style="margin-top: 10px;">
						...
						?>
						<tr>
							<td style="text-align:right; padding-right:10px;" colspan="<?= $tcol; ?>"><?= lang("សរុបបូកបញ្ចូលទាំងអាករ<br/> Total​(VAT included)"); ?></td>
							<?php
							if ($Settings->tax1 && $rows['item_tax'] != 0 && $rows['tax_code']) {
    ...
    <div style="width: 821px;margin: 20px">
        <a class="no-print" href="<?= site_url('sales'); ?>" style="border-radius: 0;margin-left: 30px;">
