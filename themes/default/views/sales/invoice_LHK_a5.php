        ...
        <div class="col-lg-12">
            <?php if (isset($biller->logo)) { ?>
                <div class="col-xs-3 text-center" style="margin-bottom:20px;">
                    <img class="img2" src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>"
            ...
            <div class="col-xs-6 text-center">
                <h3><b>លី ហ៊ុយឃីម</b></h3>
                <h4 style="padding-bottom: 10px;"><b>លក់ថ្នាំពណ៍ +  គ្រឿងដែក</b></h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    foreach ($rows as $row):
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <?php
                                if ($Settings->product_discount && $invs->product_discount != 0) {
                                    ...
                                    echo $this->erp->formatMoney($invs->product_discount);
                                }
                        ...
                        <?php if($Owner || $Admin || $GP['sales-price']){?>
                            <td colspan="4" rowspan="<?= $rows; ?>" style="padding-top:20px;border-left: 1px solid #FFF !important;​border-bottom: 1px solid #FFF !important">
                                ...
                                if ($invs->invoice_footer || $invs->invoice_footer != "") { ?>
                                    <div>
                                        <div style="font-size:11px !important;"><b><?= lang("note_kh"); ?>: </b> <?= $this->erp->decode_html(nl2br($invs->invoice_footer)); ?></div>
                                    </div>
                                    <?php
                                }
                                ?>
                    ...
                    <?php if($invs->order_discount != 0){ ?>
                        <tr>
                            ...
                            <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($invs->order_discount); ?></td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("totalpaid_kh"); ?>
                        </td>
                        <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($grand_total-$invs->total_discount); ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("deposit_kh"); ?>
                        </td>
                        <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney($invs->paid); ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:right; font-weight:bold;"><?= lang("balance_kh"); ?>
                        </td>
                        <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->erp->formatMoney(($grand_total-$invs->total_discount)-$invs->paid); ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
