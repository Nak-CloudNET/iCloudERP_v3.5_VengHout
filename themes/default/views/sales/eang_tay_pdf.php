    ...
    <div class="row">
        <div class="col-lg-7 col-lg-offset-2 col-xs-12" style="padding:0px;">
            <?php if (isset($biller->logo)) { ?>
			 ...
			 <?php } ?>
                <div class="col-xs-6 ">
                    <h2 style="font-family: Khmer M1;padding-left:70px;"><?= lang("វិក័យប័ត្រ"); ?></h2>
					<h2 style="font-family: Khmer M1;padding-left:80px;padding-top:-20px;"><?= lang("Invoice"); ?></h2>
                </div>
		</div>
	</div>	
			<div class="row" >
				<div class="col-sm-12 col-xs-12 " >
						...
						<h3 style="font-size:14px !important;line-height:23px;text-align:center;padding-top:-10px;"><b>មានទទួលកិនភ្លីធំ ភ្លីក្បឿង <br> និងផ្តត់ផ្គង់សំភារៈសំណង់ ដែក <br> ស័ង្គសី អាលុយមីញ៉ូមគ្រប់ប្រភេទ</b></h3>
						<h4></h4>
			...
			<div class="row" >
				...
				<div class="col-sm-12 col-xs-12 " style="font-size:11px;text-align:right;">
					<pdf>
						<dynamic-page>
							<div>
			...
			<div class="row" >
				<div class="col-sm-12 col-xs-12" style="font-size:11px;">
					<br>
					<div  class="col-sm-3 col-xs-3" style="font-size:11px;">
							អតិថិជន <b>&nbsp;&nbsp;<?= $customer->name?></b></div>
					<div  class="col-sm-4 col-xs-4 text-center" style="font-size:11px;">
							អាស័យដ្ឋាន : <b>&nbsp;&nbsp;<?= $customer->address?></b></div>
					<div  class="col-sm-3 col-xs-3 text-right" style="font-size:11px;">
			...
			<div class="col-ls-12 text-right"> 
					<p>
