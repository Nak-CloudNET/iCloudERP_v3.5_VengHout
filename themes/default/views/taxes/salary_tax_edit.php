...
<body>
	<?php
		...
		echo form_open_multipart("taxes/salary_tax_edit", $attrib)
	?>
		...
		<div class="row">
			...
			<table class="table table-date table-bordered" style="width:100%;">
				...
				<tr>
						...
						<input type="text" name="stD" id="stD" class="form-control textbox stD" style="
							width: 56px;
							padding-top: 2px;
							padding-bottom: 2px;
							padding-left: 2px;
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('d',strtotime($salary_tax->covreturn_start));?>" ><p class="text-style"  >From (DD)</p>
							</td>
						<td class="vertical-align: middle !important padding-less">
						...
						<input type="text" name="stM" id="stM" class="form-control stM" style="
							...
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('m',strtotime($salary_tax->covreturn_start));?>" ><p class="text-style"  >Month(MM)</p>
							</td>
						<td class="vertical-align: middle !important padding-less">
						...
						<input type="text" name="stY" id="stY" class="form-control stY" style="
							...
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('Y',strtotime($salary_tax->covreturn_start));?>" ><p class="text-style"  >Year(YYYY) </p>
						</td>
					</td>
						...
						<input type="text" name="etD" id="etD" class="form-control etD" style="
							...
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('d',strtotime($salary_tax->covreturn_end));?>" ><p class="text-style"  >To 	(DD)</p>
							</td>
						<td class="vertical-align: middle !important padding-less">
						<p class="text-style" style="margin-bottom: 0px;">ខែ</p>
						</td>
						...
						<input type="text" name="etM" id="etM" class="form-control etM" style="
							...
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('m',strtotime($salary_tax->covreturn_end));?>" ><p class="text-style"  >Month(MM) </p>
							</td>
						<td class="vertical-align: middle !important padding-less">
						<p class="text-style" style="margin-bottom: 0px;">ឆ្នាំ</p>
						</td>
						...
						<input type="text" name="etY" id="etY" class="form-control etY" style="
							...
							padding-right: 2px;
							text-align: center;
							height: 20px;" value="<?=date('Y',strtotime($salary_tax->covreturn_end));?>" ><p class="text-style"  >Year(YYYY)</p>
						</td>
					</td>
			...
			<div>
				...
				<div>
					...
					<div style="width:300px; float:left; margin-left:3%;">
						<input type="hidden" name="sal_tax_id" value="<?=$salary_tax->id;?>"/>
						<select name="enterprise" id="enterprise" class="form-control enterprise" required="required">
							<?php			
								echo '<option value=""></option>';
								foreach($enterprise as $ent){
									if($ent->id == $salary_tax->group_id) {
										echo '<option value="'.$ent->id.'" selected>'.$ent->company.'</option>';
									} else {
				...
				<!--- start----->
					<table style="margin-left: 25px;">	
						<tr>
							...
							<td colspan="5"><input type="text" class="form-control textbox" name="business_act" id="business_act" style="width: 100%;" value="<?=$salary_tax->business_activity;?>" readonly></td>
						</tr>
						<tr>
							<td><p class="text-style" style="
							margin-bottom: 0px;
						...
						">អាស័យយដ្ឋាន Address: No</p></td>
							<td><input type="text" id="address" name="address" class="form-control textbox" style="width: 220px;" value="<?=$salary_tax->address;?>" readonly></td>
							
							<td><p class="text-style" style="
							margin-bottom: 0px;
							float:left;
						"> វិថី Street </p></td><td><input type="text" name="street" id="street" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->street;?>" readonly></td>
							
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						">ក្រុមGroup</p></td><td><input name="group" id="group" type="text" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->group;?>" readonly></td>
						</tr>
						<tr>
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						">ភូមិVillage</p></td><td><input type="text" name="village" id="village" class="form-control textbox" style="width: 220px;" value="<?=$salary_tax->village;?>" readonly></td>
						
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						">ឃុំ/សង្កាត់ Sangkat</p></td>
						<td><input type="text" name="sangkat" id="sangkat" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->sangkat;?>" readonly></td>
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						"> ខ័ណ្ឌ /ក្រុង/ស្រុក District </p></td><td><input type="text" name="district" id="district" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->district;?>" readonly></td>
						</tr>
						<tr>
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						"> ខេត្ត/រាជធានី Municipality </p></td><td><input type="text" name="city" id="city" class="form-control textbox" style="width: 220px;" value="<?=$salary_tax->city;?>" readonly></td>
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						">ទូរស័ព្ឌ/ទូរសារ Phone/Fax</p></td><td><input type="text" name="phone" id="phone" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->phone;?>" readonly></td>
							<td><p class="text-style" style="
							margin-bottom: 0px;
							margin-top: 0;float:left;
						">សារអេឡិចត្រូនិច Email </p></td><td><input type="text" name="email" id="email" class="form-control textbox" style="width: 200px;" value="<?=$salary_tax->email;?>" readonly></td>
						</tr>
					</table><!--- end----->
				</div>
			</div>
			...
			<p>I. <u>ពន្ធលើប្រាក់បៀវត្សចំពោះនិយោជិកនិវាសនជន Tax on Salary on Resident Employees</u>:</p>
				<table class="table table-date table-bordered put-border">
					...
					echo	'<tr class="padding-five ta-right">
								...
								<td style="width:8%;"><input type="text" name="emp_o4[]" id="emp_04" class="form-control textbox text-right emp_04" value="'. $re->emp_num .'" style="width: 86px; float:right;"></td>
								<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_04_paid[]" id="sal_04_paid" class="form-control textbox text-right sal_04_paid" value="'. $re->salary_paid .'" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
								<td style="width:12%;"><input type="text" name="spouse[]" id="spouse" class="form-control textbox text-center spouse" value="'. $re->spouse_num .'" style="width: 100%;float:right;"></td>
								<td style="width:12%;"><input type="text" name="no_of_child[]" id="no_of_child" class="form-control textbox text-center no_of_child" value="'. $re->children_num .'" style="width: 100%;float:right;"></td>
								<td style="width:16%;"><input type="text" name="sal_cal_04[]" id="sal_cal_04" class="form-control textbox text-right sal_cal_04" value="'. $re->tax_salcalbase .'" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
								<td style="width:12%;"><input type="text" name="tax_rate_04[]" id="tax_rate_04" class="form-control text-center textbox tax_rate_04" value="'. $re->tax_rate .'" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
								<td style="width:12%;"><input type="text" name="tax_on_sal_04[]" id="tax_on_sal_04" class="form-control textbox text-right tax_on_sal_04" value="'. $re->tax_salary .'" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
							</tr>';
						$percent +=5;
						$j++;
					}
					if($j < 5) {
						...
						echo	'<tr class="padding-five ta-right">
									...
									<td style="width:8%;"><input type="text" name="emp_o4[]" id="emp_04" class="form-control textbox text-right emp_04" style="width: 86px; float:right;"></td>
									<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_04_paid[]" id="sal_04_paid" class="form-control textbox text-right sal_04_paid" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p>
									</td>
									<td style="width:12%;"><input type="text" name="spouse[]" id="spouse" class="form-control textbox text-center spouse" style="width: 100%;float:right;"></td>
									<td style="width:12%;"><input type="text" name="no_of_child[]" id="no_of_child" class="form-control textbox text-center no_of_child" style="width: 100%;float:right;"></td>
									<td style="width:16%;"><input type="text" name="sal_cal_04[]" id="sal_cal_04" class="form-control textbox text-right sal_cal_04" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
									<td style="width:12%;"><input type="text" name="tax_rate_04[]" id="tax_rate_04" class="form-control text-center textbox tax_rate_04" value="'.$percent.'" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
									<td style="width:12%;"><input type="text" name="tax_on_sal_04[]" id="tax_on_sal_04" class="form-control textbox text-right tax_on_sal_04" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
								</tr>';
							$percent +=5;
						}
					}
				...
				<div>
					...
					<table class="table table-date table-bordered put-border">
						...
						<tr class="padding-five ta-right">
							<td style="width:2%;text-align:center;"><?=$j?></td>
							<td style="width:8%;"><input type="text" name="emp_05" id="emp_05" class="form-control textbox text-right emp_05" value="<?=$nre->emp_num;?>" style="width: 86px;float:right;"></td>
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_05_paid" id="sal_05_paid" class="form-control textbox text-right sal_05_paid" value="<?=$nre->salary_paid;?>" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:16%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;"><input type="text" name="tax_rate_05" id="tax_rate_05" class="form-control textbox text-center tax_rate_05" value="20" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
							<td style="width:12%;"><input type="text" name="tax_on_sal_05" id="tax_on_sal_05" class="form-control textbox text-right tax_on_sal_05" value="<?=$nre->tax_salary;?>" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
						</tr>
						<?php
						$j++;
						}
						...
						<tr class="padding-five ta-right">
							...
							<td style="width:8%;"><input type="text" name="emp_05" id="emp_05" class="form-control textbox text-right emp_05" style="width: 86px;float:right;"></td>
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_05_paid" id="sal_05_paid" class="form-control textbox text-right sal_05_paid" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:16%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;"><input type="text" name="tax_rate_05" id="tax_rate_05" class="form-control textbox text-center tax_rate_05" value="20" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
							<td style="width:12%;"><input type="text" name="tax_on_sal_05" id="tax_on_sal_05" class="form-control textbox text-right tax_on_sal_05" value="" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
						</tr>
						<?php
						}
						?>
				...
				<div>
					...
					<table class="table table-date table-bordered put-border">
						...
						<tr class="padding-five ta-right">
							<td style="width:2%;text-align:center;"><?=$j?></td>
							<td style="width:8%;"><input type="text" name="emp_06" id="emp_06" class="form-control textbox text-right emp_06" value="<?=$fb->emp_num;?>" style="width: 86px;float:right;"></td>
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_06_paid" id="sal_06_paid" class="form-control textbox text-right sal_06_paid" value="<?=$fb->salary_paid;?>" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:16%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;"><input type="text" name="tax_rate_06" id="tax_rate_06" class="form-control textbox text-center tax_rate_06" value="20" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
							<td style="width:12%;"><input type="text" name="tax_on_sal_06" id="tax_on_sal_06" class="form-control textbox text-right tax_on_sal_06" value="<?=$fb->tax_salary;?>" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
						</tr>
						<?php
						$j++;
						}
						...
						<tr class="padding-five ta-right">
							<td style="width:2%;text-align:center;"></td>
							<td style="width:8%;"><input type="text" name="emp_06" id="emp_06" class="form-control textbox text-right emp_06" style="width: 86px;float:right;"></td>
							<td style="vertical-align: middle !important;width:15%;"><input type="text" name="sal_06_paid" id="sal_06_paid" class="form-control textbox text-right sal_06_paid" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:16%;background-color:#7f8c8d;color:white;"></td>
							<td style="width:12%;"><input type="text" name="tax_rate_06" id="tax_rate_06" class="form-control textbox text-center tax_rate_06" value="20" style="width: 90%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">%</p></td>
							<td style="width:12%;"><input type="text" name="tax_on_sal_06" id="tax_on_sal_06" class="form-control textbox text-right tax_on_sal_06" style="width: 80%;float:left;"><p style="padding-top:5px;margin-bottom: 0px;float:right;">រៀល</p></td>
						</tr>
						<?php
						}
						?>
								...
								<td valign="top" align="center">
									<table cellspacing="0" border="0">
										<tbody>
											<tr style="font-size:9px; vertical-align: top;">
												<td>
													<font style="font-family:'Khmer OS';">ធ្វើនៅ </font><input type="text" style=" size:auto; font-size:9px;border-bottom:dotted 1px #666; border-left: 0px; border-top:0px; font-weight:bolder; text-align:center;" id="kh_made_at" name="kh_made_at" value="<?=$salary_tax->filed_in_kh;?>">
												   <font style="font-family:'Khmer OS';"> ថ្ងៃទី</font>
												</td>
												<td>
													<input type="text" size="6" style=" font-size:11px; border-bottom:dotted 1px #666; border-left:  0px; border-top:0px; font-family:'Times New Roman', Times, serif; text-align:center; font-weight:bolder" value="<?=date('d',strtotime($salary_tax->created_date));?>" name="createD" id="createD" class="valid createD"> 
												   
												</td>
												<td>
													<font style="font-family:'Khmer OS';"> ខែ</font>
													<input type="text" size="6" style=" font-size:11px; border-bottom:dotted 1px #666; border-left: 0px; border-top:0px;font-family:'Times New Roman', Times, serif; text-align:center; font-weight:bolder" value="<?=date('m',strtotime($salary_tax->created_date));?>" name="createM" id="createM" class="createM"> 
												   
												</td>
												<td>
												   <font style="font-family:'Khmer OS';"> ឆ្នាំ</font>
													<input type="text" size="6" style=" font-size:11px; border-bottom:dotted 1px #666; border-left:0px; border-top:0px;font-family:'Times New Roman', Times, serif;text-align:center; font-weight:bolder " value="<?=date('Y',strtotime($salary_tax->created_date));?>" name="createY" id="createY" class="createY"> 
												</td>
											</tr>
											<tr style="font-size: 9px; vertical-align: top;">
												<td>
													Filed in <input type="text" style="size:auto; font-size:9px;border-bottom:dotted 0px #666; border-left: 0px; border-top:0px; font-family:'Times New Roman', Times, serif; border-bottom:dotted 1px #666; border-left: 0px; border-top:0px; width:160px; text-align:center;" name="en_made_at" value="<?=$salary_tax->filed_in_en;?>">
												</td>
				...
				<div>
					...
					<table  class="table table-date table-bordered put-border">
						...
						foreach($employees as $emp){
							if($emp->id == $reb->empcode){
								$emp_back_01 .=  '<option value="'.$emp->id.'" selected >'. ($emp->first_name_kh ? $emp->first_name_kh : $emp->first_name) .' '. ($emp->last_name_kh ? $emp->last_name_kh : $emp->last_name) .'</option>';
							}else{
						...
						$allowance_back_01 = ($reb->spouse + $reb->minor_children) * 75000;
						$sal_cal = $reb->salary_paid - $allowance_back_01;
						echo '<tr>
								<td><p style="padding-top: 5px;margin-bottom: 0px !important;">'.$j.'</p></td>
								<td>'. $emp_back_01 .'</td>
								<td><input type="text" name="national_back_01[]" id="national_back_01" class="form-control text-center textbox national_back_01" value="'. $reb->nationality .'" style="float:right;"></td>
								<td><input type="text" name="function_back_01[]" id="function_back_01" class="form-control text-left textbox function_back_01" value="'. $reb->position .'" style="float:right;"></td>
								<td><input type="text" name="sal_01_paid[]" id="sal_01_paid" class="form-control text-right textbox sal_01_paid" value="'. round($reb->salary_paid) .'" style="float:right;"></td>
								<td><input type="text" name="spouse_back_01[]" id="spouse_back_01" class="form-control text-center textbox spouse_back_01" value="'. $reb->spouse .'" style="float:right;"></td>
								<td><input type="text" name="child_back_01[]" id="child_back_01" class="form-control text-center textbox child_back_01" value="'. $reb->minor_children .'" style="float:right;"></td>
								<td><input type="text" name="allowance_back_01[]" id="allowance_back_01" class="form-control text-right textbox allowance_back_01" value="'. round($allowance_back_01) .'" style="float:right;"></td>
								<td><input type="text" name="sal_cal_back_01[]" id="sal_cal_back_01" class="form-control text-right textbox sal_cal_back_01" value="'. round($sal_cal) .'" style="float:right;"></td>
								<td><input type="text" name="tax_rate_back_01[]" id="tax_rate_back_01" class="form-control text-right textbox tax_rate_back_01" value="'. round($reb->tax_rate) .'" style="float:left;"><p style="padding-top: 5px;margin-bottom: 0px !important;">%</p></td>
								<td><input type="text" name="tax_on_sal_back_01[]" id="tax_on_sal_back_01" class="form-control text-right textbox tax_on_sal_back_01" value="'. round($reb->tax_salary) .'" style="float:right;"></td>
								<td><input type="text" name="remark_back_01[]" id="remark_back_01" class="form-control text-center textbox remark_back_01" value="'. $reb->remark .'" style="float:right;"></td>
							</tr>';	
							$j++;
						}
						if($j < 11){
							...
							echo '<tr>
									...
									<td><input type="text" name="sal_01_paid[]" id="sal_01_paid" class="form-control text-right textbox sal_01_paid" style="float:right;"></td>
									<td><input type="text" name="spouse_back_01[]" id="spouse_back_01" class="form-control text-center textbox spouse_back_01" style="float:right;"></td>
									<td><input type="text" name="child_back_01[]" id="child_back_01" class="form-control text-center textbox child_back_01" style="float:right;"></td>
									<td><input type="text" name="allowance_back_01[]" id="allowance_back_01" class="form-control text-right textbox allowance_back_01" style="float:right;"></td>
									<td><input type="text" name="sal_cal_back_01[]" id="sal_cal_back_01" class="form-control text-right textbox sal_cal_back_01" style="float:right;"></td>
									<td><input type="text" name="tax_rate_back_01[]" id="tax_rate_back_01" class="form-control text-right textbox tax_rate_back_01" style="float:left;"><p style="padding-top: 5px;margin-bottom: 0px !important;">%</p></td>
									<td><input type="text" name="tax_on_sal_back_01[]" id="tax_on_sal_back_01" class="form-control text-right textbox tax_on_sal_back_01" style="float:right;"></td>
				...
				<div>
					...
					<table   class="table table-date table-bordered put-border">
						...
						foreach($employees as $emp){
							if($emp->id == $fbb->empcode){
								$emp_back_02 .=  '<option value="'.$emp->id.'" selected >'. ($emp->first_name_kh ? $emp->first_name_kh : $emp->first_name) .' '. ($emp->last_name_kh ? $emp->last_name_kh : $emp->last_name) .'</option>';
							}else{
						...
						echo '<tr>
								<td>'.$j.'</td>
								<td>'.$emp_back_02.'</td>
								<td><input type="text" name="national_back_02[]" id="national_back_02" class="form-control text-center textbox national_back_02" value="'. $fbb->nationality .'" style="float:right;"></td>
								<td><input type="text" name="function_back_02[]" id="function_back_02" class="form-control text-left function_back_02" value="'. $fbb->position .'" style="float:right;"></td>
								<td><input type="text" name="sal_02_benefit[]" id="sal_02_benefit" class="form-control text-right textbox textbox sal_02_benefit" value="'. round($fbb->salary_paid) .'" style="float:right;"></td>
								...
								<td><input type="text" name="tax_on_sal_back_02[]" id="tax_on_sal_back_02" class="form-control text-right textbox tax_on_sal_back_02" value="'. round($fbb->tax_salary) .'" style="float:right;"></td>
								<td><input type="text" name="remark_back_02[]" id="remark_back_02" class="form-control text-center textbox remark_back_02" value="'. $fbb->remark .'" style="float:right;"></td>		
							</tr>';
							$j++;
						}
						if($j < 7) {
							...
							echo '<tr>
									...
									<td><input type="text" name="sal_02_benefit[]" id="sal_02_benefit" class="form-control text-right textbox textbox sal_02_benefit" style="float:right;"></td>
									<td><input type="text" name="tax_rate_back_02[]" id="tax_rate_back_02" class="form-control text-right textbox tax_rate_back_02" style="float:right;text-align:center;" value="20" readonly></td>
									<td><input type="text" name="tax_on_sal_back_02[]" id="tax_on_sal_back_02" class="form-control text-right textbox tax_on_sal_back_02" style="float:right;"></td>
