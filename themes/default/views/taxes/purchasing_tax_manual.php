<style>
	...
	.tax-model .table{border:none !important;}
	body{font-family: Khmer OS System,Nida Sowanaphum;}
	.textz{font-size:12px;line-height: 80%;} 
	.tax-model table{font-size:11px;}
</style>
<?= $modal_js; ?>
<?php 
	$suppliers =  '<select name="s3[]" id="s3" class="form-control s3">';
	$suppliers.=  '<option value=""></option>';
	foreach($billers as $biller){
		$suppliers.= '<option value="'.$biller->id.'">'.$biller->name.'</option>';
	}
	$suppliers.=  '</select>';
?>
<div class="modal-dialog modal-lg tax-model" style="width:100%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('purchasing_tax_manual'); ?></h4>
        </div>
		<?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("taxes/purchasing_tax_manual", $attrib); ?>
							...
							<table>
								<tr>
									...
									<td style="vertical-align:middle !important;">
										<div style="width:300px; float:right; margin-left:3%; display:inline;">
    ...
    <tr>
        ...
        <td style="text-align:center !important;vertical-align: middle !important;width:70px;"   rowspan="3">លេខវិក័យប័ត្រ<br>Invoice n<sup>o</sup></td>
        <td style="text-align:center !important;vertical-align: middle !important;width:100px;"   rowspan="3">អ្នកទិញ<br>Client</td>
        ...
        <td style="text-align:center !important;vertical-align: middle !important;width:50px;"   rowspan="3">បរិមាណ<br>Qty    </td>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
     ...
     if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
		...
		$('.s7, .s9, .s10, .s11, .s12').live('change', function() {
