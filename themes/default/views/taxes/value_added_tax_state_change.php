...
<?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("taxes/value_added_tax_state_change", $attrib); ?>
<div class="col-md-12 col-xs-12  col-lg-12">
	<div>
		...
		<div class="col-md-4 col-xs-4  col-lg-4"><center>
			...
			<p class="title-style" style="font-family: 'Khmer OS Muol';">លិខិតប្រកាសអាករលើតម្លៃបន្ថែម</p>
...
">	
	...
	<?php
		...
		foreach($suppid as $row){
			$opt.="<option value=".$row->id.">".$row->company."</option>";	
		}
		$bl[""] = "";
        ...
        <td>'.form_input('date_1[]', date('d-m-Y'), 'class="form-control datetime date_1"  id="date_1" required="required"').'</td>
    ...
    <tr>
        ...
        <td class="totalQTY_1"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td class="totalVAT_1"></td>
    </tr>
</table>	
			</center>
			</div>
...
Export Value</td>
	...
	<?php
        ...
        <td>'.form_input('date_2[]', date('d-m-Y') , 'class="form-control datetime" id="date_2" required="required"').'</td>
    ...
    <tr>
        <td></td>
        <td style="text-align:right">សរុប ​Total:</td>
        <td class="totalQTY_2"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td style="background-color:#7f8c8d;"></td>
        <td class="totalEXV_2"></td>
    </tr>
</table>	
			</center>
			</div>
			...
			if(month =='' || year == '' || ent_id==''){
				...
				$.ajax({
					...
					success: function (data) {
						...
						var box_16_18=(data['previous_vat'])+box_11-((data['strate_sales14'])*0.1); 
						if((data['previous_vat'])+box_11<((data['strate_sales14'])*0.1)){
							$('.pay_difference16').val(Math.round(Math.abs(box_16_18)));
						}else{
							$('.credit_forward18').val(Math.round(box_16_18));
						}
