<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('Payments return (All Warehouses)'); ?></h4>
        </div>
            ...
            <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0"
						...
						<?php
							...
							$total_balance =0;
							$amount=0;
							if($payment_returned_info->num_rows()>0){
								$i=0;
								$type="";
								foreach($payment_returned_info->result() as $row){
									$amount+=$row->amount;
