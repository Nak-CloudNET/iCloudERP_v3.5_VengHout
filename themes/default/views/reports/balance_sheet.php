...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#pdf').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/balance_sheet/'. $start .'/'.$end.'/pdf/0/'.$excel_biller_id)?>";
            return false;
        });
		$('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/balance_sheet/'. $start .'/'.$end.'/0/xls/'.$excel_biller_id)?>";
            return false;
        });
