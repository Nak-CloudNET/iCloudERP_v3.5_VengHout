        ...
        <script>
			$(document).ready(function () {
				...
				var oTable = $('#SlRData').dataTable({
					...
					'sAjaxSource': '<?= site_url('reports/getCustomerProductReport/?v=1' .$v) ?>',
					...
					"aoColumns": [{"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
	...
	<div id="top-products-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			...
			var oTable = $('#TPRData').dataTable({
					...
					"aoColumns": [
						{"bSortable": false, "mRender": checkbox}, null, null, null, {"mRender": formatQuantity}, null
					],
					"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
						var qty = 0;
						for (var i = 0; i < aaData.length; i++) {
