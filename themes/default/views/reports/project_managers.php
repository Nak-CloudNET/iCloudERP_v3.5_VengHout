<script>
    $(document).ready(function () {
        var oTable = $('#staffTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getProjectUsers') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('staff_report'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="staffTable" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped table-condensed">
                        <thead>
                        <tr>
