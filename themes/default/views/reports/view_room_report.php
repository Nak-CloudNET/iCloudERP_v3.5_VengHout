...
<ul id="myTab" class="nav nav-tabs">
    <li class=""><a href="#daily-con" class="tab-grey"><?= lang('Room_daily_sales') ?></a></li>
    <li class=""><a href="#monthly-con" class="tab-grey"><?= lang('Room_monthly_sales') ?></a></li>
    <li class=""><a href="#sales-con" class="tab-grey"><?= lang('Room_sales_report') ?></a></li>
</ul>
                                ...
                                <tr>
                                    ...
                                    if (!empty($msales)) {
                                        ...
                                        foreach ($msales as $value) {
                                            $array[$value->date] = "<table class='table table-bordered table-hover table-striped table-condensed data' style='margin:0;'><tr><td>" . lang("product_tax") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->tax1) . "</td></tr><tr><td>" . lang("order_tax") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->tax2) . "</td></tr><tr><td>" . lang("total") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->total) . "</td></tr></table>";
                                        }
