                                                ...
                                                foreach($num2 as $tr2)
                                                {
                                                    ...
                                                    if($tr2->tran_type)
                                                    {
                                                        if($tr2->tran_type == "USING STOCK" || $tr2->tran_type == "ADJUSTMENT" || $tr2->tran_type == "TRANSFER" || $tr2->tran_type == "CONVERT")
                                                        {
                                                            ...
                                                            <td style='text-align:right;'>
                                                                <?php if($allqty2->bqty){?>
                                                                    <span style="color:blue;"><?=round($allqty2->bqty,2)?></span>
                                                                    <?php
                                                                    if($qty_unit2->bqty){
                                    ...
                                    if(is_array($num)){
                                        foreach($num as $tr){
                                            if($tr->tran_type){
                                                ...
                                                echo "<td style='text-align:right; background:#428BCA;color:white;border-color: #357EBD;'><b>".round($total_in_cate_w[$tr->tran_type]?$total_in_cate_w[$tr->tran_type]:'',2)."</b></td>";
