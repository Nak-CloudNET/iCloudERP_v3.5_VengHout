<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('import_expense_csv'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchases/expense_by_csv", $attrib)
                ?>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="well well-small">
                            <a href="<?php echo base_url(); ?>assets/csv/sample_expense.csv"
