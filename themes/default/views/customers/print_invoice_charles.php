...
<html>
	...
	<div class="container">
		...
		<div class="row">
				...
				<div class="col-lg-8 col-sm-8 col-xs-8" style="border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 1px solid #000000;height:130px;width:55%;padding-top:5px;margin-left:10px;">
					<table>
						<tr>
							<td><b>Bill To</b></td>
				...
				<div class="col-lg-4 col-ms-4 col-xs-4" style="border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 1px solid #000000;height:130px;width:42%;margin-left:5px;padding-top:25px;">
					<table id="tb3">
						<tr>
							<td><b>No.</b></td>
		...
		<div class="row" style="margin-left:5px;">
			<div id='footer' class="col-lg-10 col-lg-offset-1">
				<p><b>Total Amount in word: <?=$this->erp->numberToWordsCur($deposit->amount,"");?></b></p>
