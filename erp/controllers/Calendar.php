...
class Calendar extends MY_Controller
{
    ...
    public function get_events()
    {
		...
		//$this->erp->print_arrays($input_arrays);
		...
		//$this->erp->print_arrays($output_arrays);
        // $this->erp->send_json($output_arrays);
    ...
    public function add_event()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = array(
                ...
                'start' => $this->erp->fld($this->input->post('start')),
                'end' => $this->input->post('end') ? $this->erp->fld($this->input->post('end')) : NULL,
